...
public class DynamicParticle : MonoBehaviour {	
	...
	public float GAS_FLOATABILITY=0.01f; //How fast does the gas goes up?
	public float particleLifeTime=3.0f,startTime;//How much time before the particle scalesdown and dies	
	...
	public void SetState(STATES newState){
		if(newState!=currentState){ //Only change to a different state
			switch(newState){
				...
				break;
				case STATES.GAS:		
					particleLifeTime=particleLifeTime/1.0f;	// Gas lives the time the other particles
